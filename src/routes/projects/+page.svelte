...
<section id="projects">
    <div class="projects-header">
        <h1>projects.</h1>
        <p>
          Building software is my passion. Here's a selection of projects I've created, <br>
            ...
            <a href={project.url} class="project-card" target="_blank" rel="noopener noreferrer">
                <div class="project-content">
                    ...
                    {#if project.contributionDescription && project.contributionType === 'contributor'}
                        <p class="contribution-description">{project.contributionDescription}</p>
                    {/if}
                        ...
                        <div class="project-meta">
                            ...
                            {#if project.githubUrl}
                                <button 
                                    ...
                                    on:click|stopPropagation={() => window.open(project.githubUrl, '_blank')}
                                >
